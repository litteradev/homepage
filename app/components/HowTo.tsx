        ...
        <div className={styles.items}>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.text}>
              お手紙を届けたい方をLitteraに登録します。相手がLitteraを利用していなくても、メールアドレスを入力するだけで宛先として登録できます。
            </p>
          </div>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.text}>
              お手紙をいつ届けるかを次の3つの状態から選び、日付または日数を指定します。➀平常時 / ➁死亡確定時 / ➂意思疎通困難確認時
            </p>
            <p className={styles.subtext}>
              例）死亡確定時の2100年5月5日に送付意思疎通困難確認・死亡確定の判定は、ユーザー様が指定した信頼できる方によって確認された場合のみ有効となります
            </p>
          </div>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.text}>
              ラストレター / 資産管理メモ / 日記 / 家系図などをお手紙としてお預かりいたします。任意のカテゴリを追加し、整理して保管することも可能です。
            </p>
          </div>
        </div>
      </div>
